              ...
              <div key={item.userId+index}>
                ...
                <div className='border rounded '>
                  <div className='flex flex-col lg:flex-row justify-between'>
                        ...
                        item?.productDetails.map((product,index)=>{
                          return(
                            <div key={product.productId+index} className='flex gap-3 bg-slate-100'>
                                <img src={product?.image[0]} alt="chiku" className='w-28 h-30 bg-slate-200 object-scale-down p-2' />
                                <div>
                    ...
                    <div>
                      <div className='text-lg font-medium'>Payment Deatils :</div>
                            ...
                            item.shipping_options.map((shipping,index)=>{
                              return(
                                <div key={shipping.shipping_rate} className='ml-1'>
                                  Shipping Amound:{shipping.shipping_amount}
                                </div>
                              )
                            })
                          }
